...
//**globals**
global.config = new utils_1.Config();
global.port = 4443;
//**app**
...
let server = https_1.default.createServer({
    key: fs_1.default.readFileSync(path_1.default.resolve(config.directoryPath + "/privkey.pem")),
    cert: fs_1.default.readFileSync(path_1.default.resolve(config.directoryPath + "/cert.pem")),
}, app);
